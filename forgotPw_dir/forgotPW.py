...
if config.DEV_MODE:
    ...
    print(memberDB.members)



def isMember(uId):

    return uId in memberDB.members


def checkEmail(uId, uMail):

    return memberDB.members[uId]['uMail'] == uMail
...
def findID():
    ...
    while True:
        ...
        for uId, uInfo in memberDB.members.items():
...
def findPassword():
    ...
    memberDB.members[uId]['uPw'] = tempPw
